...
function Home() {
  return (
    <div className="Home flex flex-row">
      <div className="leftdiv flex flex-col w-2/3 p-16">
        <h1 className="text-7xl font-bold p-5">
          A heritage in care.
          <br />A reputation in excellence.
        </h1>
        <p className="m-7 text-lg text-gray-500">
          IndiHospitality provides excellent services by prioritizing the
          safety and security of patients. Finding nearest hospital for you.
        </p>
